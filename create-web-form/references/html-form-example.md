...
Only request password input when necessary, use HTTPS for transport, and hash or verify the submitted value on the server instead of storing raw password text.

```html
<form>
  <label for="username">Username:</label><br>
  <input type="text" id="username" name="username"><br>
  <label for="current-passphrase">Password:</label><br>
